...
const solvedBefore = "2019-09-01";

let results = [];
const searchUrl = `https://${zendeskSubdomain}.zendesk.com/api/v2/search.json?query=type:ticket status:solved solved<${solvedBefore}`;
